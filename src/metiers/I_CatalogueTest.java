...
//		cat.clear();
    ...
    @Test
    public void testRemoveProduit_existe() throws SQLException {
    ...
    @Test
    public void testRemoveProduit_existePas() throws SQLException {
        cat.addProduit("Mars", 10, 1);
        cat.addProduit("Treets", 10, 1);
        cat.addProduit("Raider", 12, 2);
    ...
    @Test
    public void testRemoveProduit_null() throws SQLException {
        cat.addProduit("Mars", 10, 1);
        cat.addProduit("Treets", 10, 1);
        cat.addProduit("Raider", 12, 2);
    ...
    @Test
    public void testAcheterProduit_existePas() throws SQLException {
        cat.addProduit("Mars", 10, 1);
        cat.addProduit("Treets", 10, 1);
        cat.addProduit("Raider", 12, 2);
    ...
    @Test
    public void testAcheterProduit_existe() throws SQLException {
        cat.addProduit("Mars", 10, 1);
        cat.addProduit("Treets", 10, 1);
        cat.addProduit("Raider", 12, 2);
    ...
    @Test
    public void testAcheterProduit_quantiteNegative() throws SQLException {
        cat.addProduit("Mars", 10, 1);
        cat.addProduit("Treets", 10, 1);
        cat.addProduit("Raider", 12, 2);
    ...
    @Test
    public void testAcheterProduit_quantiteNulle() throws SQLException {
        cat.addProduit("Mars", 10, 1);
        cat.addProduit("Treets", 10, 1);
        cat.addProduit("Raider", 12, 2);
    ...
    @Test
    public void testVendreProduit_existePas() throws SQLException {
    ...
    @Test
    public void testVendreProduit_existe() throws SQLException {
        cat.addProduit("Mars", 10, 5);
        cat.addProduit("Treets", 10, 0);
        cat.addProduit("Raider", 12, 3);
    ...
    @Test
    public void testVendreProduit_quantiteNegative() throws SQLException {
        cat.addProduit("Mars", 10, 5);
        cat.addProduit("Treets", 10, 0);
        cat.addProduit("Raider", 12, 3);
    ...
    @Test
    public void testVendreProduit_quantiteNulle() throws SQLException {
        cat.addProduit("Mars", 10, 5);
        cat.addProduit("Treets", 10, 0);
        cat.addProduit("Raider", 12, 3);
    ...
    @Test
    public void testVendreProduit_stockNul() throws SQLException {
        cat.addProduit("Mars", 10, 5);
        cat.addProduit("Treets", 10, 0);
        cat.addProduit("Raider", 12, 3);
    ...
    @Test
    public void testVendreProduit_stockInsuffisant() throws SQLException {
        cat.addProduit("Mars", 10, 5);
        cat.addProduit("Treets", 10, 0);
        cat.addProduit("Raider", 12, 3);
    ...
    public void testClear() {
        ...
        cat.addProduit("Raider", 1, 10);
        cat.clear();
        assertEquals("Methode clear", resultatAttendu, cat.toString());
    }
